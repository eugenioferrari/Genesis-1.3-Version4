...
public:
    ...
    void initEField(double, int, int, int, double, bool, bool, int, double);
...
inline void Beam::initEField(double rmax, int ngrid, int nz, int nphi, double lambda, bool lngr, bool hghgrange, int maxharm, double scaling){
    solver.initEField(rmax, ngrid, nz, nphi, lambda, lngr, hghgrange, maxharm, scaling);
}
